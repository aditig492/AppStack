          ...
          <ul class="sidebar-nav">
            <li class="sidebar-item active">
              ...
              <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show">
                <li class="sidebar-item active">
					<router-link class="sidebar-link" :to="{name:'BillingPage'}">Billing</router-link>
                </li>
                <li class="sidebar-item">
                  <a class="sidebar-link" href="dashboard-analytics.html">Expenses</a>
                </li>
                <li class="sidebar-item">
                  <a class="sidebar-link" href="dashboard-e-commerce.html">Inventory</a>
                </li>
              </ul>
            </li>
          </ul>
      ...
      <div class="main">
        <nav class="navbar navbar-expand navbar-light bg-white">
          ...
          <form class="form-inline d-none d-sm-inline-block">
            <input
              class="form-control form-control-no-border mr-sm-2"
              type="text"
                    ...
                    <a href="#" class="list-group-item">
                      <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-10 pl-2">
                          ...
                          >Nam pretium turpis et arcu. Duis arcu tortor.</div>
                    ...
                    <a href="#" class="list-group-item">
                      <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-10">
                          ...
                          <div
                            class="text-muted small mt-1"
                          >Restart server 12 to complete the update.</div>
                          <div class="text-muted small mt-1">2h ago</div>
                        </div>
                      </div>
                    </a>
                    <a href="#" class="list-group-item">
                      <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-10">
                          ...
                          <div
                            class="text-muted small mt-1"
                          >Aliquam ex eros, imperdiet vulputate hendrerit et.</div>
